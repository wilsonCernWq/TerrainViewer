...
public:
    ...
    void draw(const mat4& T, const mat4& M, const mat4& V, const mat4& P, const mat4& LVP, vec2& origin, bool inverted){
        glUseProgram(_pid);
        glBindVertexArray(_vao);
        {
            ...
            glUniform1f(glGetUniformLocation(_pid, "waterHeight"), *waterHeight);
            glUniform1i(glGetUniformLocation(_pid, "inverted"), inverted);
